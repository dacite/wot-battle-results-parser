...
use super::Vector3;
use crate::{events::{EventPrinter, Version, VersionInfo}, packet_parser::serde_packet};
use crate::Result;
...
impl VehicleMiscStatus {
    pub fn from(data: &[u8], version: [u16; 4]) -> Result<Self> {
        let misc_status: UpdateVehicleMiscStatus = serde_packet::from_slice(data, version)?;
        ...
        Ok(VehicleMiscStatus { avatar_id: misc_status.avatar_id, status_detail })
    }
}
