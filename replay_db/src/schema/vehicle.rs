...
pub struct Vehicle {
    ...
    pub credits: i32,
    pub damage_assisted_inspire: Option<i32>,
    pub damage_assisted_radio: i32,
    pub damage_assisted_smoke: Option<i32>,
    pub damage_assisted_stun: Option<i32>,
    pub damage_assisted_track: i32,
    pub damage_blocked_by_armor: i32,
    pub damage_dealt: i32,
    pub damage_received: i32,
    pub damage_received_from_invisibles: Option<i32>,
    pub damaged: i32,
    pub damaged_hp: Option<i32>,
    pub death_count: i32,
    pub death_reason: i32,
    pub destructibles_damage_dealt: Option<i32>,
    pub destructibles_hits: Option<i32>,
    pub destructibles_num_destroyed: Option<i32>,
    pub direct_enemy_hits: Option<i32>,
    pub direct_hits: i32,
    pub direct_hits_received: i32,
    pub direct_team_hits: i32,
    pub dropped_capture_points: i32,
    pub equipment_damage_dealt: Option<i32>,
    ...
    pub num_defended: Option<i32>,
    pub num_recovered: Option<i32>,
    pub piercing_enemy_hits: Option<i32>,
    pub piercings: i32,
    ...
    pub stun_num: Option<i32>,
    pub stunned: Option<i32>,
    pub tdamage_dealt: i32,
    pub tdestroyed_modules: i32,
    pub tkills: i32,

    pub vehicle_num_captured: Option<i32>,
    pub win_points:           i32,
    pub xp:                   i32,
    #[serde(rename = "xp/assist")]
    pub xp_assist:            Option<i32>,
    #[serde(rename = "xp/attack")]
    pub xp_attack:            Option<i32>,
    #[serde(rename = "xp/other")]
    pub xp_other:             Option<i32>,
    pub xp_penalty:           Option<i32>,
